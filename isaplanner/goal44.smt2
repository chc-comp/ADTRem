...
(assert
  (forall ( (A Int) (B listOfInt) (C pairOfIntInt) (D listOfpairOfIntInt) )
    (=>
      (zip (conslistOfInt A B) nillistOfInt (cons-listOfpairOfIntInt C D))
      ff
    )
  )
)
(assert
  (forall ( (A Bool) (B Int) (C listOfInt) (D Int) (E listOfInt) (F listOfpairOfIntInt) (G listOfpairOfIntInt) )
    (=>
      (and
        (= A false)
        (zip (conslistOfInt B C) (conslistOfInt D E) F)
        (zip C E G)
