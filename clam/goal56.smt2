...
(assert
  (forall ( (A Bool) (B Int) (C Int) (D Int) (E Int) (F Int) (G listOfInt) (H listOfInt) (I listOfInt) (J listOfInt) (K listOfInt) (L listOfInt) (M listOfInt) )
    (=>
      (and
        (= A false)
        (= B (+ 1 C))
